...
public interface ProductiveCycleInputRepository extends
  ...
  @Modifying
  @Query(value = "INSERT INTO jt_productcycle_input(productive_cycle_input_id, productive_cycle_id, input_id) VALUES (nextval('prod_cycle_input_seq'), :productiveCycleId, :inputId)", nativeQuery = true)
